...
class WordCloudViewSet(viewsets.ViewSet):
	'''
	Endpoint to generate a Twitter wordcloud image.
	...
	- Mandatory: comments
	- Optionals: user_id
	If user_id is given, it will generate a random wordcloud with some mask
	located in static/images/cloud. In other case, wordcloud will be with 
	square form
	'''
