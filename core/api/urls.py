...
#    url(r'^index/', views.IndexView.as_view(), name='index')    
    ...
    url(r'^api/search/word_details/user/<int:user_id>/social_network/<int:social_network_id>/word/<int:word_id>', SearchViewSet.as_view({'post': 'word_details'}), name='word_details')
]
