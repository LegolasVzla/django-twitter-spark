...
#    url(r'^index/', views.IndexView.as_view(), name='index')    
    ...
    url(r'^api/word_cloud/comments/<string:comments>/user_id/<int:user_id>', WordCloudViewSet.as_view({'get': 'list', 'post':'create'}), name='word_cloud'),
    ...
    url(r'^api/big_data_layer/tweets_processing', BigDataViewSet.as_view({'post':'tweets_processing'}), name='big_data_layer')
]
