...
def loaddata():
	...
	subprocess.call("python3 manage.py loaddata fixtures/"+'positive_spanish_dictionary.json',shell=True)
	subprocess.call("python3 manage.py loaddata fixtures/"+'negative_spanish_dictionary.json',shell=True)
